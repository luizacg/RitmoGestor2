...
from .models import Class, Student, Attendance, Course, Teacher, Assign, AssignTime, AttendanceClass
...
class ClassAdmin(admin.ModelAdmin):
    list_display = ('id', 'sem', 'section')
    search_fields = ('id', 'sem', 'section')
    ordering = ['sem', 'section']
...
class AssignAdmin(admin.ModelAdmin):
    ...
    search_fields = ('class_id__id', 'course__name', 'teacher__name', 'course__shortname')
    ordering = ['class_id__id', 'course__id']
...
class AttendanceClassAdmin(admin.ModelAdmin):
    ...
    def reset_attd(self, request):
        ...
        self.message_user(request, "As Frequencias foram deletadas com sucesso!")
